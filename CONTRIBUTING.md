...
Welcome to `pre-commit-hooks` contributor's guide.
...
If you experience bugs or general issues with `pre-commit-hooks`, please have a look
...
You can help improve `pre-commit-hooks` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`pre-commit-hooks` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `pre-commit-hooks`'s files. While this mechanism can
...
```
conda create -n pre-commit-hooks python=3 six virtualenv pytest pytest-cov
conda activate pre-commit-hooks
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/pre-commit-hooks.git
   cd pre-commit-hooks
   ```
...
5. Install [pre-commit]:
   ...
   `pre-commit-hooks` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/pre-commit-hooks
[issue tracker]: https://github.com/<USERNAME>/pre-commit-hooks/issues
